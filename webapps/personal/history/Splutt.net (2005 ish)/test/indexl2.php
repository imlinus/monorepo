...
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" style="background-image: url(kludd.gif); background-repeat: no-repeat;">
	<tr><td align="center" valign="center">
<table width="900" cellpadding="0" cellspacing="10">
	<tr>
				<td width="900" colspan="2"  style="border: 1px #000000 dotted;" bgcolor="#0000ff" align="right">
<div id="top">
<br><br><br><br><br><br>
</div>
		</td>
	...
	<tr>
		...
		<td width="300"  valign="top"    bgcolor="#ffffff" style="border: 1px #000000 dotted;" height="300">
<div id="meny" >
...
<br><br><br><br><div align="center" ></b> </div>
		...
		<td width="690" rowspan="2" valign="top" style="border: 1px #000000 dotted;background-image: url(top2.gif); background-repeat: no-repeat;" bgcolor="#C2C287" >
<div id="mit">
