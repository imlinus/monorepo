...
För att beställa hem dessa bilder måste du ha WAP i din mobil. <br> för du kommer att få en länk som sms.<br><br>

OBS. för att beställa hem en bild kostar 5kr.
...
//inställningar!
  ...
  $data_file = "wap-pad";
  $this_script = "wap.php"; // detta är om du t.ex. har includerat scriptet i en annan sida. skriv länken till denna filen!
