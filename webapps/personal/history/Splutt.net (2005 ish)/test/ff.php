...
<form onSubmit="SearchText(q.value); return false; document.form.submit.value='Sök nästa'" name="form">
<input type="text" name="q" value="Skriv sökord här">
<input type="Submit" value="Tryck enter" name="submit" onclick="document.form.submit.value='Sök nästa'" >
</form>
<!--END OF EDIT-->
