...
function movenemies() {
	...
	else if (gametime >= 100 &&  gametime < 150) speed = 100;
	else if (gametime >= 150 &&  gametime < 300) speed = 20;
	...
	if (finaltime == 0) {
		finaltime = calctime();
			if (finaltime >= 20) {
				...
				window.alert('Du klarade ' + finaltime + ' sekunder. \nGrattis, du klarade spelet!');
				location.href = "index.php?lvl=8";
				} else {
		window.alert('Du klarade ' + finaltime + ' sekunder. Försök igen...'); 
...
<div id="box" style="position: absolute; top: 180; left: 180; width:70; height:60; layer-background-color: #990000; background-color: #990000;">
<table width="70" height="60">
<tr><td>&nbsp;</td></td></tr>
</table>
</div>

<div id="enemy0" style="position: absolute; top: 330; left: 270; width:60; height:50; layer-background-color: #000099; background-color: #000099;">
<table width="60" height="50">
<tr><td>&nbsp;</td></tr>
</table>
</div>

<div id="enemy1" style="position: absolute; top: 60; left: 300; width:100; height:20; layer-background-color: #000099; background-color: #000099;">
<table width="100" height="20">
<tr><td>&nbsp;</td></tr>
</table>
</div>

<div id="enemy2" style="position: absolute; top: 70; left: 70; width:30; height:60; layer-background-color: #000099; background-color: #000099;">
<table width="30" height="60">
<tr><td>&nbsp;</td></tr>
</table>
</div>

<div id="enemy3" style="position: absolute; top: 320; left: 70; width:60; height:60; layer-background-color: #000099; background-color: #000099;">
...
<table border="0" cellspacing="0" cellpadding="0" background="bg.bmp">
<!-- row 1 -->
<tr>
	<td width="50" height="50" bgcolor="#ffffff"><table><tr><td></td></tr></table></td>
	<td width="50" height="50" bgcolor="#ffffff"><table><tr><td></td></tr></table></td>
	<td width="50" height="50" bgcolor="#ffffff"><table><tr><td></td></tr></table></td>
	<td width="50" height="50" bgcolor="#ffffff"><table><tr><td></td></tr></table></td>
	<td width="50" height="50" bgcolor="#ffffff"><table><tr><td></td></tr></table></td>
