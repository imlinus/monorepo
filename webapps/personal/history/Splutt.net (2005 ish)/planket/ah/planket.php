<body background="http://www.pixgallery.com/dbimages/ib/PIX-115020903.jpg"><meta http-equiv="refresh" content="3">
<?
...
//inställningar!
  ...
  $data_file = "pad";
  $this_script = "planket.php"; // detta är om du t.ex. har includerat scriptet i en annan sida. skriv länken till denna filen!
...
<font color="yellow" style="font-family:Porky's; font-size: 28px;">
<?php
...
------------------------------------------------------*/
   ...
   echo "Ditt klotter är skickat!<script> setTimeout(\"history.go(-1)\",2000); alert('Ditt klotter är skickat!');</script>";
break;
} //--end switch
?>